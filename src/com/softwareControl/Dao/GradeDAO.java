 ...
 * 
 * @see com.softwareControl.Dao.Grade
...
public class GradeDAO {
	...
	public Grade findById(java.lang.Integer id) {
		...
		try {
			Grade instance = (Grade) getCurrentSession().get("com.softwareControl.Dao.Grade", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Grade instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.softwareControl.Dao.Grade")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Grade instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Grade as model where model." + propertyName + "= ?";
	...
	public List findByGrade3(Object grade3) {
		return findByProperty(GRADE3, grade3);
	}
	...
	public Grade merge(Grade detachedInstance) {
		...
		try {
			Grade result = (Grade) getCurrentSession().merge(detachedInstance);
