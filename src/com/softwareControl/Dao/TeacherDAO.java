 ...
 * 
 * @see com.softwareControl.Dao.Teacher
...
public class TeacherDAO {
	...
	public static final String TPOSITION = "tposition";
	public static final String TEMAIL = "temail";
	public static final String TTEL = "ttel";
	...
	public Teacher findById(java.lang.Integer id) {
		...
		try {
			Teacher instance = (Teacher) getCurrentSession().get("com.softwareControl.Dao.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.softwareControl.Dao.Teacher")
	...
	public List findByTposition(Object tposition) {
		return findByProperty(TPOSITION, tposition);
	}
	...
	public List findByTtel(Object ttel) {
		return findByProperty(TTEL, ttel);
	}
	...
	public Teacher merge(Teacher detachedInstance) {
		...
		try {
			Teacher result = (Teacher) getCurrentSession().merge(detachedInstance);
