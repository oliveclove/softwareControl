 ...
 * 
 * @see com.softwareControl.Dao.Student
...
public class StudentDAO {
	...
	public static final String SHOBBY = "shobby";
	...
	public Student findById(java.lang.Integer id) {
		...
		try {
			Student instance = (Student) getCurrentSession().get("com.softwareControl.Dao.Student", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.softwareControl.Dao.Student")
	...
	public List findByShobby(Object shobby) {
		return findByProperty(SHOBBY, shobby);
	}
	...
	public Student merge(Student detachedInstance) {
		...
		try {
			Student result = (Student) getCurrentSession().merge(detachedInstance);
