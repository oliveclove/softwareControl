 ...
 * 
 * @see com.softwareControl.Dao.Admin
...
public class AdminDAO {
	...
	public Admin findById(java.lang.Integer id) {
		...
		try {
			Admin instance = (Admin) getCurrentSession().get("com.softwareControl.Dao.Admin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.softwareControl.Dao.Admin")
