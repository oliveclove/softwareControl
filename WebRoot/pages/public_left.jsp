...
<html>
  ...
  <!--side S-->
	<div class="super-side-menu">
		...
		<div class="side-menu">
			<ul>
				<li class=""><a href="file/showall.action" target="Mainindex"><i class="ico-1"></i>上传任务书</a></li>
				<li><a href="group/allGroup.action" target="Mainindex"><i class="ico-2"></i>小组管理</a></li>
				<li><a href="grade/showall.action" target="Mainindex"><i class="ico-6"></i>成绩管理</a></li>
